...
class Session(object):
    ...
    def _create_token(self):
        ...
        try:
            response = requests.post(
                urls.login(), json=payload, headers=self._headers(), verify=self._verifySsl)
    ...
    def _get_groups(self):
        ...
        try:
            response = requests.get(
                urls.get_groups(), headers=self._headers(), verify=self._verifySsl)
    ...
    def set_device(self, id, **kwargs):
        ...
        if kwargs is not None:
            for key, value in kwargs.items():
                ...
                if key == 'ecoFunctionData' and isinstance(value, constants.EcoFunctionData) and value != constants.EcoFunctionData.Unavailable:
    ...
    def _read_parameters(self, parameters={}):
        ...
        if 'ecoFunctionData' in parameters:
            value['ecoFunctionData'] = constants.EcoFunctionData(
                parameters['ecoFunctionData'])
